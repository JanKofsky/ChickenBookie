  ...
  return (
    <main className="shell simple-page">
      ...
      <section className="panel">
        ...
        <p className="muted">
          Chicken Bookie stores event setup, chicken names, race details, pool entries, Venmo handles supplied by hosts and bettors, an official host Venmo profile link for host-maintained pools, payment reference IDs, host-recorded payment-confirmation status, results, and settlement math so race hosts can run their event.
        </p>
        <p className="muted">
